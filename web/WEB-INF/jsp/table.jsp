...
<!DOCTYPE html>
<div class="card mb-3" style="width: 1890px; margin-left: -390px">
                ...
                <tbody>
                    <c:forEach var="b" items="${staffs}">
                        <tr>
                            ...
                            <td>${b.departId}</td>
                            <td>${b.capdo}</td>
                            <td><a href="student-mgr.htm?lnkEdit&id=${b.id}">Sửa</a> | <a href="student-mgr.htm?lnkDelete&id=${b.id}">Xóa</a></td>
                        </tr>
                    </c:forEach>
                </tbody>  
