            ...
            <section id="contact" class="section-bg wow fadeInUp">
                <div class="container">
                    ...
                    <div class="section-header">
                        <h3><spring:message code="lable.home.li4" text="Thêm phòng ban"/></h3>
                        <p><spring:message code="tile.home.l42" text="Thêm phòng ban vào danh sách của công ty."/></p>
                    ...
                    <div class="form" style="  font-family: Times New Roman;">
                        <form action="departs.htm" method="post" modelAttribute="departins" role="form" class="contactForm">
                            <c:set var="departins" value="${departins}"></c:set>
                                <div class="form-row" style="color: red">
                                    ...
                                    <div class="form-group col-md-6">
                                        <spring:message code="fi.c1" text="Mã phòng ban"/><input type="text" class="form-control" name="id" value="${departins.id}" id="email" placeholder="<spring:message code="fi.c1" text="Mã phòng ban"/>" data-rule="minlen:2" data-msg="<spring:message code="fi.c1" text="Mã phòng ban"/>" />
                                    <div class="validation"></div>
                                </div>
                                <div class="form-group col-md-6">
                                    <spring:message code="fi.c2" text="Tên phòng ban"/><input type="text" name="name" value="${departins.name}" class="form-control" id="name" placeholder="<spring:message code="fi.c2" text="Tên phòng ban"/>" data-rule="minlen:1" data-msg="<spring:message code="fi.c2" text="Tên phòng ban"/>" />
                                    <div class="validation"></div>
                                </div>
                            </div>
                            ...
                            <div class="form-row" style="color: red">
                                ...
                                <div class="text-center" style="padding-left: 435px; padding-top: 24px; padding-bottom: 24px;"><button name="btnInsertDP" type="submit"><spring:message code="btn.add" text="Thêm"/></button>&nbsp;&nbsp;&nbsp;<button name="btnReset" type="submit">Reset</button></div>
                            </div> 
                        </form>
                    </div>
