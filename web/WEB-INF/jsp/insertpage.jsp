            ...
            <section id="contact" class="section-bg wow fadeInUp">
                <div class="container">
                    <div class="section-header">
                        <h3><spring:message code="lable.home.li3" text="Thêm nhân viên"/></h3>
                        <p><spring:message code="tile.home.l41" text="Thêm thông tin của nhân viên mới được thực hiện bởi nhân viên quản trị."/></p>
                    ...
                    <div class="form" style="font-family: Times New Roman;">
                        ...
                        <form:form action="insertpage.htm" method="post" modelAttribute="staffins" role="form" class="contactForm">
                            <c:set var="staffins" value="${staffins}"></c:set>
                                <div class="form-row" style="color: red;" >
                                    <div class="form-group col-md-6">
                                        <spring:message code="fi.a1" text="Mã số"/><input readonly=""  type="text" name="id" value="${staffins.id}" class="form-control" id="name" placeholder="<spring:message code="fi.a1" text="Mã số"/>" data-rule="minlen:1" data-msg="Vui lòng nhập mã số" />
                                    <div class="validation"></div>
                                </div>
                                <div class="form-group col-md-6">
                                    <spring:message code="fi.a2" text="Họ tên"/><input type="text" class="form-control" name="name" value="${staffins.name}" id="email" placeholder="<spring:message code="fi.a2" text="Họ tên"/>" data-rule="minlen:1" data-msg="Vui lòng nhập họ tên" />
                                    <div class="validation"></div>
                                </div>
                            </div>
                            <div class="form-row" style="color: red">
                                ...
                                <div class="form-group col-md-6">
                                    <spring:message code="fi.a4" text="Ngày sinh"/><input type="text" class="form-control" name="birthday" value="${staffins.birthday}" id="email" placeholder="<spring:message code="fi.a4" text="Ngày sinh"/>" data-rule="minlen:10" data-msg="Vui lòng nhập ngày sinh" />
                                    <div class="validation"></div>
                                </div>
                            </div> 
                            ...
                            <div class="form-row" style="color: red">
                                <div class="form-group col-md-6">
                                    <spring:message code="fi.a5" text="Hình ảnh"/><input onchange="readURL(this)" type="file" name="photo" value="${staffins.photo}" class="form-control" data-rule="minlen:1" id="name" data-msg="<spring:message code="fi.a5" text="Hình ảnh"/>" />
                                    <div class="validation"></div>
                                </div>
                                <div class="form-group col-md-6">
                                    <spring:message code="fi.a6" text="Email"/><input type="email" class="form-control" name="email" value="${staffins.email}" id="email" placeholder="Email" data-rule="email" data-msg="<spring:message code="fi.a6" text="Email"/>" />
                                    <div class="validation"></div>
                                </div>
                            </div> 
                            <div class="form-row" style="color: red">
                                <div class="form-group col-md-6">
                                   <spring:message code="fi.a7" text="Số điện thoại"/><input type="text" name="phone" value="${staffins.phone}"class="form-control" id="name" placeholder="<spring:message code="fi.a7" text="Số điện thoại"/>" data-rule="minlen:10" data-msg="Vui lòng nhập số điện thoại" />
                                    <div class="validation"></div>
                                </div>
                                <div class="form-group col-md-6">
                                    <spring:message code="fi.a8" text="Lương"/><input type="text" class="form-control" name="salary" value="${staffins.salary}" id="email" placeholder="<spring:message code="fi.a8" text="Lương"/>" data-rule="minlen:6" data-msg="Vui lòng nhập lương" />
                                    <div class="validation"></div>
                                </div>
                            </div> 
                            <div class="form-row" style="color: red">
                                <div class="form-group col-md-6">
                                    <spring:message code="fi.a9" text="Ghi chú"/><input type="text" name="notes" value="${staffins.notes}" class="form-control" id="name" placeholder="Ghi chú" data-msg="<spring:message code="fi.a9" text="Ghi chú"/>" />
                                    <div class="validation"></div>
                                </div>
                                <div class="form-group col-md-6">
                            ...
                            <div class="form-row" style="color: red">
                                ...
                                <div class="text-center" style="padding-left: 5px; padding-top: 24px"><button name="btnInsert" type="submit"><spring:message code="btn.add" text="Thêm"/></button>&nbsp;&nbsp;   &nbsp;&nbsp;<button name="btnReset" type="submit">Reset</button></div>
                            </div> 
                        </form:form>
                    </div>
                    <%@include file="table_st.jsp" %>
                </div>
            </section><!-- #contact -->
