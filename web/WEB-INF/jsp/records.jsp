            ...
            <section id="contact" class="section-bg wow fadeInUp">
                <div class="container">
                    ...
                    <div class="section-header">
                        <h3><spring:message code="lable.home.li5" text="Thêm thành tích"/></h3>
                        <p><spring:message code="tile.home.l43" text="Ghi nhận thành tích, kỹ luật của nhân viên."/></p>
                    ...
                    <div class="form" style="  font-family: Times New Roman;">
                        <form action="records.htm" method="post" modelAttribute="recordins" role="form" class="contactForm">
                            ...
                            <div class="form-row" style="color: red">
                                ...
                                <div class="text-center" style="padding-left: 435px; padding-top: 24px"><button name="btnInsertRC" type="submit"><spring:message code="btn.add" text="Thêm"/></button>&nbsp;&nbsp;&nbsp;<button name="btnReset" type="submit">Reset</button></div>
                            </div> 
                            <br>
                        </form>   
                    </div>
